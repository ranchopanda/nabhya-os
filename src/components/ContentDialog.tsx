    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            {post ? "Update status or metrics." : "Plan or log a piece of content."}
          </DialogDescription>
        </DialogHeader>
        <form
          className="space-y-3"
        ...
        >
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={mut.isPending || !topic.trim()}>
              {mut.isPending ? "Saving…" : post ? "Save" : "Add"}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>

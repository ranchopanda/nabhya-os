...
export const MOCK_LEADS: Lead[] = [
  {
    ...
    notes: "Interested in soil analysis.",
  ...
  },
  {
    ...
    designation: "CTO",
    email: "jane@foodtech.com",
    phone: "+0987654321",
    category: "Food Tech",
    status: "Pilot Discussion",
    notes: "Wants to integrate our API.",
    next_action: "Follow up on API keys",
  ...
  },
  {
    id: "l3",
    company: "GovAgri",
    contact_name: "Official Bob",
    designation: "Director",
    email: "bob@gov.org",
    phone: null,
    category: "Government",
    status: "Customer",
    notes: "Signed 1 year contract.",
    next_action: null,
    follow_up_date: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
...
export const MOCK_PILOTS: Pilot[] = [
  {
    id: "p1",
    name: "Soil Sensor V2 Beta",
    organization: "AgriCorp",
    start_date: "2026-05-01",
    end_date: "2026-08-01",
    status: "Running",
    objectives: "Test sensor accuracy.",
    kpis: "99% accuracy",
    results: null,
    progress: 40,
    created_at: new Date().toISOString(),
...
export const MOCK_MILESTONES: Milestone[] = [
  {
    ...
    description: "Raised $500k.",
    occurred_on: "2026-01-15",
    category: "Funding",
  },
  {
    id: "m2",
    title: "Product MVP Launched",
    description: "First version live.",
...
export const MOCK_PRODUCT_UPDATES: ProductUpdate[] = [
  {
    ...
    description: "Improved soil prediction by 15%.",
    problem_solved: "Low accuracy in dry regions.",
    impact: "+15% accuracy",
    category: "AI",
    owner_name: "Alice",
  ...
  },
  {
    ...
    description: "Moved to React Start.",
    problem_solved: "Slow load times.",
    impact: "-50% load time",
    category: "Frontend",
    owner_name: "Bob",
...
export const MOCK_TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    name: "Alice Founder",
    role: "CEO",
    skills: "BizDev, Pitching",
    linkedin: "linkedin.com/in/alice",
    responsibilities: "Fundraising",
    current_focus: "YC",
    wins_this_month: "Got interview",
    user_id: "bypass",
  },
  {
    id: "tm2",

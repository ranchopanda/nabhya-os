...
export const Route = createFileRoute("/_authenticated/milestones")({
  head: () => ({
    meta: [
      { title: "Milestones · Nabhya OS" },
      { name: "description", content: "The story of Nabhya, in chronological order." },
    ],
  }),
  loader: ({ context }) => {
    ...
    <div className="relative pl-8">
      ...
      {milestones.map((m, i) => (
        <div key={m.id} className="relative pb-10 last:pb-0">
          <div
            className="absolute -left-[22px] top-1 h-4 w-4 rounded-full border-4 border-background"
